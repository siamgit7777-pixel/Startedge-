    ...
    <section className="py-20 px-5 bg-white" id="about">
      <div className="max-w-6xl mx-auto flex flex-col lg:flex-row gap-16 items-center">
        ...
        <div className="flex-1">
          <span className="section-badge">About Startedge</span>
          ...
          <p className="text-gray-500 text-base leading-relaxed mb-4">
            Startedge is an automated blood service that connects blood
            searchers with voluntary blood donors in a moment through SMS. We
            are a not-for-profit initiative to raise awareness of voluntary
            blood donation in Bangladesh.
          </p>
          <p className="text-gray-500 text-base leading-relaxed mb-8">
            We believe that no patient should suffer due to lack of blood when
            there are thousands of willing donors across the country.
          </p>
        </div>
        ...
        <div className="flex-1 grid grid-cols-2 gap-4 w-full">
          {highlights.map((item) => (
            ...
            >
              <span className="text-red-600 text-xl mb-3 block">
                {item.icon}
              </span>
